...
$seguridadin = $consulta->reservatipo($r,'GINECOLOGIA');
            ...
            <div class="col-md-10">
                <div class="row">
                    ...
                    <div class="col-md-6 reserva_bt">
                        ...
                        ?>
                        <a href="reservaGI.php?f=<?php echo $datofecha[4];?>" type="button" class="btn btn-success btn-block" >Siguente</a>
                    </div>
                </div>
            </div>
            <div class="col-md-1"></div>
                    ...
                    <table class="table table-bordered">
                        ...
                        for ($i=1; $i <=19 ; $i++) {
                            ...
                            for($d=0;$d<5;$d++){
                                ...
                                $verifica = $consulta->verificarhora($diahora,'GINECOLOGIA');
                                if(empty($verifica)){
