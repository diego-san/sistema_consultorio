...
$seguridadin = $consulta->reservatipo($r,'DENTAL');
            ...
            <div class="col-md-10">
                <div class="row">
                    ...
                    <div class="col-md-6 reserva_bt">
                        ...
                        ?>
                        <a href="reservaDEN.php?f=<?php echo $datofecha[4];?>" type="button" class="btn btn-success btn-block" >Siguente</a>
                    </div>
                </div>
            </div>
            <div class="col-md-1"></div>
                    ...
                    <table class="table table-bordered">
                        ...
                        for ($i=1; $i <=10 ; $i++) {
                            ...
                            for($d=0;$d<5;$d++){
                                ...
                                $verifica = $consulta->verificarhora($diahora,'DENTAL');
                                if(empty($verifica)){
