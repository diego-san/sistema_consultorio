...
$seguridadin = $consulta->reservatipo($r,'MENTAL');
            ...
            <div class="col-md-10">
                <div class="row">
                    ...
                    <div class="col-md-6 reserva_bt">
                        ...
                        ?>
                        <a href="reservaMEN.php?f=<?php echo $datofecha[4];?>" type="button" class="btn btn-success btn-block" >Siguente</a>
                    </div>
                </div>
            </div>
            <div class="col-md-1"></div>
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        $fechaActual = "07:00";
                        for ($i=1; $i <=10 ; $i++) {
                            $nuevaFecha = strtotime ( '+60 minute' , strtotime ( $fechaActual ) ) ;
                            ...
                            for($d=0;$d<5;$d++){
                                ...
                                $verifica = $consulta->verificarhora($diahora,'MENTAL');
                                if(empty($verifica)){
