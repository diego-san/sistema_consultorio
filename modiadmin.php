        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="in_clinica.php">Lista</a></li>
                    <li><a href="modiadmin.php">Modificar Mis Datos</a></li>
    ...
    <div class="container-fluid admin-fondo">
        <div class="row ">
            <div class="col-md-10 col-md-offset-1 admin_tirulo">
                <h2 class="text-center">Modificar mis datos</h2>
            </div>
            <div class="col-md-1"></div>
        </div>
        <div class="row">
            <div class="col-md-10 col-md-offset-1" >
                <form action="procemodiad.php " method="get">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="apellido" required id="ap" minlength="1" class="form-control" value="<?php echo $datos[0][4];?>">
                                <label for="ca">Cargo: </label>
                                <input type="text" name="cargo" required id="ca" minlength="1" class="form-control" value="<?php echo $datos[0][3];?>">
                                <label for="fechanac" class=" control-label">Fecha de Nacimiento:</label>
                                <div class="input-group date form_date " data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                    <input class="form-control" size="16" type="text" value="<?php echo $datos[0][9];?>" readonly name="fecha_nac">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="titulo" required id="ti" minlength="1" class="form-control" value="<?php echo $datos[0][5];?>">
                                <label for="tele">Numero de telefono: </label>
                                <input type="tel" name="telefono" required id="tele" minlength="8" maxlength="11" class="form-control" pattern="[0-9]{8,11}"title="Solo numeros" value="<?php echo $datos[0][6];?>">
                                <label for="mail">Email</label>
                                <input type="email" class="form-control" id="mail" name="correo" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" value="<?php echo $datos[0][7];?>">
                                <label for="dir">Direccion: </label>
                                <input type="text" name="direc" required id="dir" minlength="1" class="form-control" value="<?php echo $datos[0][8];?>">
